...
$Linea = $_POST['Linea'];
$Modelo = $_POST['Modelo'];
//$ubicacon = $_POST['fotos'];

//echo $Marca, $Linea,$Modelo;

$sql = "INSERT INTO vehiculo VALUES(null, '$Marca','$Linea','$Modelo')";
...
foreach ($_FILES["img"]["tmp_name"] as $key => $tmp_name) {
	...
	if (move_uploaded_file($ubicacion, $ubicacionFinal)) {
		$sql = "INSERT INTO fotos VALUES(null,'$ultimoCodigoInsertado','$ubicacionFinal')";
   		mysqli_query($Conexion, $sql);
